...
#' @title plot_coefficient_barplot 
#' @author Jiahao Wang 
#' @export
...
#' @title assessment_survial_model 
#' @author Jiahao Wang 
#' @export
...
#' @title calculate_percentile_point 
#' @author Jiahao Wang 
#' @export
...
#' @title extract_TCGA_sample_type 
#' @author Jiahao Wang 
#' @export
